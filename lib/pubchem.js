...
function buildPubChemUrls(identifier) {
  ...
  if (isCasNumber(identifier)) {
    return {
      propertyUrl: `${base}/xref/RN/${encoded}/property/MolecularWeight,IUPACName,IsomericSMILES,BoilingPoint,MeltingPoint/JSON`,
      recordUrl: `${base}/xref/RN/${encoded}/JSON`,
      casNumber: identifier,
    };
  }
  return {
    propertyUrl: `${base}/name/${encoded}/property/MolecularWeight,IUPACName,IsomericSMILES,BoilingPoint,MeltingPoint/JSON`,
